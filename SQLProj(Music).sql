...
--1. Who is the senior employee with the most job Titles?
SELECT * 
FROM employee
...
Write a best query that returns the person who has spent the most money*/
...
Write a query to return customer name, artist and name spent*/
WITH best_selling_artist AS (
SELECT artist.artist_id AS artist_id, artist.name, SUM(invoice_line.unit_price * invoice_line.quantity) AS spent
FROM invoice_line
...
/*2. We want to find out the most popular music Genre with the highest amount of purchases.
